...
function realizaProceso(){
        ...
        $.ajax({
                ...
                url:   'CrearTienda.php',
                type:  'post',
                success:  function() {   alert('Tienda registrada');  }
        });
}
</script>
...
<fieldset>
<legend><strong>Informacion Tienda</strong></legend>
<table width="776" height="70" border="0" cellpadding="2" cellspacing="0">
 ...
 <tr>
  ...
  <tr>
     ...
     <td width="20">&nbsp;</td>
     <td width="105"><label for="label">Latitud:</label></td>
     <td width="70"><input type="text" name="T13" id="Latitud" size="30" maxlength="32" /></td>
     <td width="16">&nbsp;</td>
 </tr>
  <tr>
     <td width="16" scope="row">&nbsp;</td>
     ...
     <td width="209">&nbsp;</td>
     <td width="20">&nbsp;</td>
     <td width="105"><label for="label">Longitud:</label></td>
     <td width="70"><input type="text" name="T13" id="Longitud" size="30" maxlength="32" /></td>
     <td width="16">&nbsp;</td>
 </tr>
</table>
</fieldset>
...
<table width="788"  border="0" id="example">
  <thead>
    <tr >
	  <td width="128" height="25"><span class="Estilo15">Codigo Tienda</span></td>
...
<tr>
  <td><span class="Estilo3"><?php echo $op['codigo_tienda'];?></span></td>
