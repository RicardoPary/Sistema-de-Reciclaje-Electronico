...
$consulta=$cn->prepare('SELECT * FROM tienda');
$consulta->execute();
?>
...
<table width="776" height="74" border="0" cellpadding="2" cellspacing="0">
 ...
 <tr>
   <td scope="row">&nbsp;</td>
   <td height="26" scope="row"><label for="label2">Tienda:</label></td>
   <td>
	...
	?>
             ...
             <option value="<?php echo $result['codigo_tienda']?>"><?php echo $result['nombre']?></option>
