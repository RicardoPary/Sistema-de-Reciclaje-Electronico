...
<?php	
    ...
    include("Conexion.php");
  	$cod=$_POST['Texto'];
	$sql=$cn->prepare("SELECT * FROM producto WHERE (nombre LIKE :Codigo) OR (tipo LIKE :Codigo) OR (descripcion LIKE :Codigo) ");
...
<table width="195" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><label style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:11px;  color:#000000;">Cantidad</label></td>
    <td>&nbsp;</td>
    <td><label style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:11px;  color:#000000;"><?php echo $op['cantidad']; ?> </label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><label style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:11px;  color:#000000;">Tipo</label></td>
    <td>&nbsp;</td>
    <td><label style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:11px;  color:#000000;"><?php echo $op['tipo']; ?></label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
