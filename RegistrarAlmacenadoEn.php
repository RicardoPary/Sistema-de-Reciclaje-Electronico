...
<head>
<title>Registrar almacenado de productos</title>
...
//WHERE codigo_producto NOT IN (SELECT codigo_producto FROM almacenado_en)
$consulta=$cn->prepare('SELECT * FROM producto');
$consulta->execute();

$consulta1=$cn->prepare('SELECT * FROM tienda');
$consulta1->execute();
 ...
 <tr>
  ...
  <tr>
   ...
   <td><select size="1" name="select" id="CodigoSucursal">
	...
	{
	?>
     <option value="<?php echo $result1['codigo_tienda']?>"><?php echo $result1['nombre'];?></option>
     <?php 
	}
	?>
   </select></td>
...
<table width="788"  border="0" id="example">
  <thead>
    <tr >
      ...
      <td width="106"><span class="Estilo15">Codigo Tienda</span></td>
