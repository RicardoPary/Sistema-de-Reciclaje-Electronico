...
<ul id="menu">
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0">   
       <tr>
         <td width="217" rowspan="4" ><img src="Imagenes/logoblanco.png" width="170" height="58" style="margin-left:20px;"/></td>
         ...
         <td colspan="2" rowspan="4" ><form class="form" action="Login.php" method="post" style=" float:right; padding:0px; margin:0px;">
           <table width="369" border="0" cellpadding="0" cellspacing="0">
             ...
             <tr>
              ...
              <td>&nbsp;</td>
              <td><input name="submit" type="submit" style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:11px; color:#FFFFFF; float:left; margin-left:5px; background:#666666; border:1px #000000 solid; height:25px; cursor:pointer; font-weight:bold;" value="Iniciar Sesion"/></td>
            </tr>
             <tr>
               <td>
               </td>
      ...
      <tr>
       <td width="424" height="14" ></td>
      </tr>
  
  <tr>
  <td>
  
     <input name="Buscar" id="Buscar" type="text" placeholder="        Busca envetos, anuncios y cosas " style="width:400px;" onclick="realizaProceso();"/>   </td>
