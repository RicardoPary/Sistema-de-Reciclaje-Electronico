...
include("Conexion.php");
	...
	$consulta=$cn->prepare('INSERT INTO almacen(numero_almacen,codigo_tienda,nombre,tipo,ubicacion,capacidad)VALUES(:NumeroAlmacen,:CodigoSucursal,:Nombre,:Tipo,:Ubicacion,:Capacidad)');
